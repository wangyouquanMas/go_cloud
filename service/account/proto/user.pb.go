...
type RespSignup struct {
	...
	Mesaage              string   `protobuf:"bytes,2,opt,name=mesaage,proto3" json:"mesaage,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RespSignup) GetMesaage() string {
	if m != nil {
		return m.Mesaage
	}
	return ""
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	0x49, 0x70, 0xb1, 0xe7, 0xa6, 0x16, 0x27, 0x26, 0xa6, 0xa7, 0x42, 0x35, 0xc3, 0xb8, 0x46, 0x76,
	...
	0x89, 0x21, 0x89, 0x0d, 0x2c, 0x66, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x37, 0x6d, 0x6b, 0x08,
	0xdc, 0x00, 0x00, 0x00,
}
